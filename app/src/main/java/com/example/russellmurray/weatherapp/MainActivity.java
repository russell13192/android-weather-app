package com.example.russellmurray.weatherapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void findWeather(View view) {
        ...
        try {
            ...
            task.execute("http://api.openweathermap.org/data/2.5/weather?q=" + encodedCityName + ",us&APPID=15693fd706940299b23640f5fb323c3f");
